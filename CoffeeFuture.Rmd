...
The purpose of this project is to forecast **categories** (also called **classes**), \"buy,\" \"Neutral\" or \"sell.\" In order to be able to perform this type of classification analysis, we create additional labels that are categorical.
...
**valuation** (earning yields, accounting ratios); **profitability** and quality (return on equity); **momentum** and technical analysis (past returns, relative strength index); **risk** (volatilities); **estimates** (earnings-per-share); **volume** and **liquidity** (share turnover).
