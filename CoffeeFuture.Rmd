...
The extensions are technical indicators based on a daily Close Price of ICF and are select based on
Chartered Financial Analyst (CFA®) program curriculum. This choice make sense economically since this knowledge are wild spread to the market and the decisions are made at the closing call every day.
